    ...
    public BasicCacheContainer getCacheContainer() {
        if (manager == null) {
            ...
            Configuration loc = new ConfigurationBuilder()
                ...
                .eviction().maxEntries(10).strategy(EvictionStrategy.LIRS) //Sets  4 as maximum number of entries in a cache instance and uses the LIRS strategy - an efficient low inter-reference recency set replacement policy to improve buffer cache performance
